function [Flow,Flowlose] = NRLFA1(PVGEN1)
...
[Lineloss , Voltagepu,Flow ,Flowlose]=loadflow1(nbus,V,del,BMva,BKv,BC,PVGEN,PVGENQ);        % Calling Loadflow.m.. 

% Linelosssum=sum(Lineloss);                                     %  Sum of Apparent Power Loss (MVA)
% 
