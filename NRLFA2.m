function [Linelosssum] = NRLFA2(PVGEN1)
...
busd = busdatas(nbus,PVGEN);% Calling busdatas..
BMva = 100;                 % Base MVA..
...
[Lineloss , Voltagepu,Flow ,Flowlose]=loadflow1(nbus,V,del,BMva,PVGEN);        % Calling Loadflow.m.. 
